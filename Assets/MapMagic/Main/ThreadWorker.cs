...
namespace MapMagic
{
	...
	public class ThreadWorker 
	{
		...
		{
			#if WDEBUG
			UnityEngine.Profiling.Profiler.BeginSample("Refresh Threads");
			#endif
		...
		public static void UpdateApply ()
		{
			...
			#if WDEBUG
			UnityEngine.Profiling.Profiler.BeginSample("Update Apply");
			#endif
...
//					maxProirityNum = i;
		...
		{try{
			...
			#if WDEBUG
			if (IsMainThread) UnityEngine.Profiling.Profiler.BeginSample("Update Threads");
			#endif
			...
			{
				#if WDEBUG
				if (IsMainThread) UnityEngine.Profiling.Profiler.EndSample();
				#endif
